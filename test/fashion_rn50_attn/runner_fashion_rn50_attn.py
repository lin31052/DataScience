# DataScience-Kaggle GPU runner: STEP1 kaggle CLI 下载 Fashion-MNIST → STEP2 clone → STEP3 T4 x2 并行训练
...
TRAIN_SCRIPT = "test/fashion_rn50_attn/train_fashion_rn50_attn.py"
...
# ===== STEP3: T4 x2 GPU 训练 (双卡并行) =====
log('STEP3: training on GPU (T4 x2 parallel)...')
subprocess.run(
    [sys.executable, "-u",
